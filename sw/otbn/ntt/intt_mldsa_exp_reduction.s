 ...
 *
 * It performs a conditional subtraction after each Montgomery multiplication. This allows to use
 * a Montgomery multiplication implementation without the conditional subtraction which reduces
 ...
 */
 .global intt_mldsa_exp_reduction
intt_mldsa_exp_reduction:
  /* Set up WDRs indexes */
   ...
   * Conditional Subtractions: 4 * 8 = 32
   * Clear w24                          2
  ...
  loopi 2, 273
    ...
    bn.xor w24, w24, w24 /* clear register for conditional subtraction */
    ...
    bn.addvm.8S w3,  w3,  w24 /* conditional subtraction */
    bn.subvm.8S w31, w4,  w6
    bn.addvm.8S w4,  w4,  w6
    bn.mulvm.8S w6,  w31, w17
    bn.addvm.8S w6,  w6,  w24 /* conditional subtraction */
    ...
    bn.addvm.8S w10, w10, w24 /* conditional subtraction */
    ...
    bn.addvm.8S w14, w14, w24 /* conditional subtraction */
    ...
    bn.addvm.8S w4,  w4,  w24 /* conditional subtraction */
    ...
    bn.addvm.8S w12, w12, w24 /* conditional subtraction */
   ...
   * We expect the following instruction count:
   * Butterflies:  4 * 8 * 3            = 96 (layers * Vectorized Butterflies * InsnPerVecButterfly)
   * Conditional subtraction: 4 * 8 + 8 = 40
   * Clear w24                             1
  ...
  loopi 2, 177
    ...
    bn.addvm.8S  w8,  w8,  w24 /* conditional subtraction */
    ...
    bn.addvm.8S  w0, w0, w24 /* conditional subtraction */
